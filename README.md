...
One more thing: if you use a container for a deployment process, you'll lose terraform status as soon as the container is destroyed, so it's a good idea to run the command `terraform destroy terraform` when you've done with testing.
